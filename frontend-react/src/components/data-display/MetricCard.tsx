...
const MetricCard = memo(function MetricCard({ label, value, loading = false, icon, className = '', progress, progressColor, progressTextColor = 'text-slate-600', subtitle }: MetricCardProps) {
