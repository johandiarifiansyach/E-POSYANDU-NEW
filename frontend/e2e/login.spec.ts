...
test('login dapat dipakai dengan keyboard, footer rilis, dan pengaturan password', async ({ page }, testInfo) => {
  ...
  const versionButton = page.getByRole('button', { name: 'E-Posyandu v3.5.5' });
  ...
  for (const version of ['v3.5.5', 'v3.5.4', 'v3.5.3', 'v3.5.2', 'v3.5.1', 'v3.5.0', 'v3.4.5', 'v3.4.4', 'v3.4.3', 'v3.4.1', 'v3.4.0', 'v3.3.0', 'v3.0.0', 'v2.4.0', 'v2.0.0', 'v1.0.0']) {
