...
Jalankan `npm run standards:verify` untuk memastikan file data lokal belum berubah dan frontend, Worker, serta modul Python yang dimuat `analysis-worker` memakai tabel antropometri yang identik.
