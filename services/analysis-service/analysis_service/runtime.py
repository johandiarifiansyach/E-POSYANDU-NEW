...
class BoundedWorkerQueue:
    ...
    def __init__(self, workers: int, queue_size: int, acquire_timeout: float = 1.0) -> None:
        ...
        self._executor = ThreadPoolExecutor(max_workers=self.workers, thread_name_prefix="analysis-worker")
...
class AnalysisRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        self.workers = BoundedWorkerQueue(worker_count, queue_size, queue_timeout)

    @classmethod
    def from_env(cls) -> "AnalysisRuntime":
        return cls(
